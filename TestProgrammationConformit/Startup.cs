...
namespace TestProgrammationConformit
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddSingleton<IEvenementRepo, SqlEvenementRepo>();
            services.AddScoped<IEvenementRepo, SqlEvenementRepo>();
            services.AddScoped<IPersonneRepo, SqlPersonneRepo>();
            services.AddScoped<ICommentaireRepo, SqlCommentaireRepo>();
        }
